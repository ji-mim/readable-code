...
import cleancode.minesweeper.tobe.minesweepr.io.sign.CellSignFinder;
import cleancode.minesweeper.tobe.minesweepr.io.sign.CellSignProvider;
...
//                String cellSign = cellSignFinder.findCellSignFrom(snapshot);
    ...
    @Override
    public void showGameLosingCommet() {
