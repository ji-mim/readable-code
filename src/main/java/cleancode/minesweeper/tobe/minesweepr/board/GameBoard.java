package cleancode.minesweeper.tobe.minesweepr.board;

import cleancode.minesweeper.tobe.minesweepr.board.cell.Cell;
import cleancode.minesweeper.tobe.minesweepr.board.cell.CellSnapshot;
import cleancode.minesweeper.tobe.minesweepr.board.cell.Cells;
import cleancode.minesweeper.tobe.minesweepr.board.cell.EmptyCell;
import cleancode.minesweeper.tobe.minesweepr.board.cell.LandMineCell;
import cleancode.minesweeper.tobe.minesweepr.board.cell.NumberCell;
import cleancode.minesweeper.tobe.minesweepr.board.position.CellPosition;
import cleancode.minesweeper.tobe.minesweepr.board.position.CellPositions;
import cleancode.minesweeper.tobe.minesweepr.board.position.RelativePosition;
...
public class GameBoard {
    ...
    public boolean isInvalidCellPosition(CellPosition cellPosition) {
        ...
        return cellPosition.isRowIndexMoreThanOrEqual(rowSize)
            || cellPosition.isComIndexMoreThanOrEqual(colSize);
    }
